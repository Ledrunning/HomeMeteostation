//*****************************************************************************
//Что бы работало на PORTC - отключи JTAGEN на Demoboard!
...
#define LCD_B4	4	//define MCU pin connected to LCD D3
#define LCD_B5	5	//define MCU pin connected to LCD D4
#define LCD_B6	6	//define MCU pin connected to LCD D5
#define LCD_B7	7	//define MCU pin connected to LCD D6
...
void f(uint8_t progress, uint8_t maxprogress, uint8_t length);
